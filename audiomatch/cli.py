...
def print_pair_results(res: QueryResult, out=None) -> None:
    ...
    w("  Two kinds of evidence, and they answer different questions.\n"
      ...
      "  When the envelope's own peak is not dominant -- a close mic or a\n"
      "  direct input hears one player, not the room, so several lags score\n"
      "  alike -- its lag is not trusted: the landmark search is re-run\n"
      "  without a window and either places the pair itself or the hit says\n"
      "  the lag is unreliable.\n"
